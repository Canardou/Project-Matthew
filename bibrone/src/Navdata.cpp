...
namespace Navdata {
    ...
    namespace IMU {
        ...
        namespace Gyroscope {
            ...
            /* D'apr�s la doc du Invensense 3000 on a une "sensitivy" = 16.4 LSB/dps pour une FS de 2000 (d'apr�s
            paparazzi, on a une FS de 2000, cf. je sais plus quel header... ). Si on a  16.4 LSB/dps, la valeur
            par laquelle il faut multiplier les donn�es brutes c'est 1/16.4... Ce qui fait du 0.0609, �a me parait
            plus coh�rent que le 4.359 ci-dessous. */
